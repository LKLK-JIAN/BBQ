...
public class FragmentContent2 extends Fragment {
    ...
    private View v;
    private MyViewPager myvp_fragment_content2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_content2, null);
        myvp_fragment_content2=v.findViewById(R.id.myvp_fragment_content2);
        fragments = new ArrayList<Fragment>();
        pagerAdapter = new MyViewPagerAdapter(getChildFragmentManager(),
                fragments);
        myvp_fragment_content2.setOffscreenPageLimit(2);
        myvp_fragment_content2.setAdapter(pagerAdapter);
...
//        fragments.add(new ChanneltwoFragment());
    ...
    public void setCurrentPage(int pageIndex) {
        myvp_fragment_content2.setCurrentItem(pageIndex);
    }
}
